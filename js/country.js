...
const search_country_element = window.document.querySelector(".search_country");
const close_list_btn= window.document.querySelector("#close");
const country_list_element = window.document.querySelector(".country_list");
const change_country_btn = window.document.querySelector(".change_country");
const input =window.document.getElementById("#search_input")

// Create the country list

function createcountrylist() {
    const num_countries = countrylist.length;
    let i = 0 ,ul_list_id;
...
// ADDING EVENTLISTENERS TO SHOW AND HIDE THE LIST
...
$(document).ready(function(){
    $('#search_input').on('keyup',function(){
        ...
        $(".country_list li").show().filter(function(){
